...
--local wifi_widget = require("wifi_iw")
...
beautiful.notification_font = "sfns display 14"
...
mytextclock = awful.widget.textclock("  %a, %b %e %H:%M  ")
...
globalkeys = gears.table.join(
    ...
    awful.key({"Control", modkey  }, "p", function () awful.util.spawn("/usr/bin/i3-scrot -d")   end,
